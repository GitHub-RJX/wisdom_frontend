  ...
  <div class="Page Confirm">
    ...
    <form name="flowForm" id="flowForm" method="post" action="">
      <table class="GoodList">
        ...
        <tbody>
          <tr v-if="order.totalFee == 0.01">
            <!-- <td colspan="3" class="Title red f18 fb"><p>限时折扣商品</p></td> -->
          </tr>
          <tr>
          ...
          <tr class="good">
            ...
            <td class="red priceNew Last price">
              <p>
                ￥<strong>{{ order.totalFee }}</strong>
              </p>
              <span class="discName red">限时0.01抢购</span>
            </td>
          </tr>
          <tr>
...
export default {
  asyncData({ params, error }) {
    return ordersApi.getOrderByNo(params.no).then((response) => {
      return {
