        ...
        <section class="fl t-infor-box c-desc-content">
          <div class="mt20 ml20">
            ...
            <h3 class="hLh30">
              ...
              <span style="font-size: 16px">{{ teacher.level === 0 ? '初级讲师' : (teacher.level === 1 ? '高级讲师' : '首席讲师') }}</span>
            </h3>
            <section class="mt10">
              ...
              <li v-for="course in courseList" :key="course.id">
                <div class="cc-l-wrap">
                  ...
                  <h3 class="hLh30 txtOf mt10">
                    <a href="#" :title="course.title" target="_blank" class="course-title fsize18 c-333">{{ course.title
                    }}</a>
                  </h3>
                </div>
              </li>
