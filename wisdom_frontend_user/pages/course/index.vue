      ...
      <section class="c-sort-box">
        <section class="c-s-dl">
          <dl>
            ...
            <dd class="c-s-dl-li">
              <ul class="clearfix">
                ...
                <li v-for="(item, index) in subjectParentList" :key="index" :class="{ active: oneIndex == index }">
          ...
          <dl v-show="this.oneIndex != -1">
            ...
            <dd class="c-s-dl-li">
              <ul class="clearfix">
                <li v-for="(item, index) in subjectList" :key="index" :class="{ active: twoIndex == index }">
        ...
        <div class="mt40">
          ...
          <article v-if="data.total > 0" class="comm-course-list">
            <ul class="of" id="bna">
              <li v-for="item in data.eduCourseList" :key="item.id">
                <div class="cc-l-wrap">
  ...
  methods: {
    ...
    initSubject() {
      courseApi.getAllSubject()
        .then(response => {
          this.subjectParentList = response.data.data
        })
    },
    ...
    searchOne(subjectParentId, index) {
      ...
      for (let i = 0; i < this.subjectParentList.length; i++) {
        //获取每个一级分类
        var oneSubject = this.subjectParentList[i]
        //比较id是否相同
    ...
    searchBuyCount() {
      //设置对应变量值，为了样式生效
      this.buyCountSort == "" ? this.buyCountSort = "1" : this.buyCountSort = ""
      this.gmtCreateSort = ""
      this.priceSort = ""
    ...
    searchGmtCreate() {
      //设置对应变量值，为了样式生效
      this.buyCountSort = ""
      this.gmtCreateSort == "" ? this.gmtCreateSort = "1" : this.gmtCreateSort = ""
      this.priceSort = ""
    ...
    searchPrice() {
      ...
      this.buyCountSort = ""
      this.gmtCreateSort = ""
      this.priceSort == "" ? this.priceSort = "1" : this.priceSort = ""
